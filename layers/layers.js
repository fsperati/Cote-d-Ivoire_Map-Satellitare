...
lyr_GoogelSatellite_0.setVisible(true);lyr_RESEAU_ROUTIER_WEB_1.setVisible(true);lyr_Mission4_Entretien_classique_2.setVisible(true);lyr_Ville_F_3.setVisible(true);lyr_Ville_D_4.setVisible(true);
var layersList = [baseLayer,lyr_GoogelSatellite_0,lyr_RESEAU_ROUTIER_WEB_1,lyr_Mission4_Entretien_classique_2,lyr_Ville_F_3,lyr_Ville_D_4];
...
lyr_Ville_D_4.set('fieldAliases', {'x': 'x', 'y': 'y', 'OBJECTID': 'OBJECTID', 'regions': 'regions', 'DEBUT': 'DEBUT', 'Departemen': 'Departemen', 'DISTRICT': 'DISTRICT', 'OBSERVATIO': 'OBSERVATIO', 'Shape_Leng': 'Shape_Leng', 'longueur': 'longueur', });
...
lyr_Ville_D_4.set('fieldImages', {'x': 'TextEdit', 'y': 'TextEdit', 'OBJECTID': 'TextEdit', 'regions': 'TextEdit', 'DEBUT': 'TextEdit', 'Departemen': 'TextEdit', 'DISTRICT': 'TextEdit', 'OBSERVATIO': 'TextEdit', 'Shape_Leng': 'TextEdit', 'longueur': 'TextEdit', });
...
lyr_Mission4_Entretien_classique_2.set('fieldLabels', {'OBJECTID': 'no label', 'regions': 'no label', 'DEBUT': 'no label', 'FIN_1': 'no label', 'Departemen': 'no label', 'DISTRICT': 'no label', 'OBSERVATIO': 'no label', 'Shape_Leng': 'no label', 'longueur': 'no label', 'x': 'no label', 'y': 'no label', 'x_fin': 'no label', 'y_fin': 'no label', });
...
lyr_Ville_D_4.set('fieldLabels', {'x': 'inline label', 'y': 'inline label', 'OBJECTID': 'no label', 'regions': 'inline label', 'DEBUT': 'inline label', 'Departemen': 'inline label', 'DISTRICT': 'inline label', 'OBSERVATIO': 'no label', 'Shape_Leng': 'no label', 'longueur': 'no label', });
lyr_Ville_D_4.on('precompose', function(evt) {
