var size = 0;
var placement = 'point';
function categories_RESEAU_ROUTIER_WEB_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
var style_RESEAU_ROUTIER_WEB_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_RESEAU_ROUTIER_WEB_1(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
